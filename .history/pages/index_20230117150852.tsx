...
const [res, setRes] = useState<string | null>(null);
  ...
  <div className="flex flex-col m-4">
    <label className="text-lg font-medium mb-2" for="name">Name:</label>
  ...
  <div className="flex flex-col m-4">
    <label className="text-lg font-medium mb-2" for="description">Description:</label>
  ...
  <div className="flex flex-col m-4">
    <label className="text-lg font-medium mb-2" for="file">File:</label>
    <input className="bg-white focus:outline-none focus:shadow-outline-blue border border-gray-300 rounded-lg py-2 px-4 block w-full leading-5"
