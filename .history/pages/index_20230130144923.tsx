...
const [description, setDescription] = useState<string | null>(null);
  ...
  { 
  <div className="flex justify-center">
    <p className="text-lg font-medium mb-2" > Your NFT has been sucessfully minted on the Arweave blockchain you can see by clicking on this link <a target="_blank" href={respoonse}> {respoonse}</a></p>
  </div>
}
