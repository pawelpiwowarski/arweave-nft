...
const [description, setDescription] = useState<string | null>(null);
  ...
  <div className="flex flex-col m-4">
    <p className="text-lg font-medium mb-2" > {respoonse && "Your Atomic NFT has been sucessfully minted on the Arweave blockchain"}</p> </br> <p> {"you can see by clicking on this link"} <a target="_blank" href={respoonse}> {respoonse}</a></p>
  </div>
