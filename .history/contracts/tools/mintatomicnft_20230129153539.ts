...
export const mintAtomicNFT = async (address: any, raw_data: ArrayBuffer, name: any, descrition: any) => {
    ...
    console.log(raw_data)
    const tx = await bundlr.upload(raw_data as Buffer , { tags: contractTags });
