...
export const mintAtomicNFT = async (address: any, raw_data: Blob, name: any, descrition: any) => {
    ...
    const mimetype = raw_data.mimetype
    ...
    const tx = await bundlr.upload(raw_data , { tags: contractTags });
